 ...
 */
public class _SK extends Structure<_SK, _SK.ByValue, _SK.ByReference > {
	 ...
	 */
	public _SK(byte ID_Datchik[], byte Temperature, byte Korrect, short K_Zub, byte MaxSkorVr, byte Date_Poverki[], byte Slug_Inf[]) {
		super();
	...
	protected _SK newInstance() { return new _SK(); }
	public static _SK[] newArray(int arrayLength) {
		return Structure.newArray(_SK.class, arrayLength);
	}
	public static class ByReference extends _SK implements Structure.ByReference {
		
	};
	public static class ByValue extends _SK implements Structure.ByValue {
