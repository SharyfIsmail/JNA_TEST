...
public interface T_45 extends Library {
	...
	public interface DECODER_CREATE extends Callback {
		Pointer apply(int NKan, byte DecoderType, T_45.DATA_HANDLER DataHandler, Pointer PContext, _SpecialParametrs PSpecialParametrs);
	};
	...
	public interface DECODER_READ_TRANSDUCER_PARAM extends Callback {
		int apply(Pointer PDecoder, _SK PTranducerParametrs, Pointer StrokaDatchikID);
	};
	 ...
	 */
	Pointer DecoderCreate(int NKan, byte DecoderType, T_45.DATA_HANDLER DataHandler, Pointer PContext, _SpecialParametrs PSpecialParametrs);
	/**
	 ...
	 */
	@Deprecated 
	int DecoderReadTranducerParametrs(Pointer PDecoder, _SK PTranducerParametrs, Pointer StrokaDatchikID);
	/**
	 * Original signature : <code>int DecoderReadTranducerParametrs(void*, _SK*, char*)</code><br>
	 * <i>native declaration : line 196</i>
	 */
	int DecoderReadTranducerParametrs(Pointer PDecoder, _SK PTranducerParametrs, ByteBuffer StrokaDatchikID);
	/**
