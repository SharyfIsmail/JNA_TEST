 ...
 */
public class _SpecialParametrs extends Structure<_SpecialParametrs, _SpecialParametrs.ByValue, _SpecialParametrs.ByReference > {
	/** \u0422\u0438\u043f \u0444\u0438\u043b\u044c\u0442\u0440\u0430 */
	 ...
	 */
	public testDllProject._ParamComPort.ByReference PParamComPort;
	/**
	 * \u0410\u0434\u0440\u0435\u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u0430<br>
	 * C type : char*
	 */
	...
	protected _SpecialParametrs newInstance() { return new _SpecialParametrs(); }
	public static _SpecialParametrs[] newArray(int arrayLength) {
		return Structure.newArray(_SpecialParametrs.class, arrayLength);
	}
	public static class ByReference extends _SpecialParametrs implements Structure.ByReference {
		
	};
	public static class ByValue extends _SpecialParametrs implements Structure.ByValue {
